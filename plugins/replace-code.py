...
patterns = {
    ...
    r'\[\[include :backrooms-wiki:component:license-box-end\]\]': r'[[include :backrooms-wiki-cn:component:license-box-end]]',
    r'\[\[include :backrooms-wiki:component:open\]\]': r'[[include :backrooms-wiki-cn:credit:start]]',
    r'\[\[include :backrooms-wiki:component:close\]\]': r'[[include :backrooms-wiki-cn:credit:end]]'
}
